...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player1 = findViewById(R.id.ScoreX);
        player2 = findViewById(R.id.ScoreY);
        ...
        Reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                xCount=0;
                oCount=0;
                player2.setText("Player 1 :- "+String.valueOf(xCount));
                player2.setText("Player 2:- "+String.valueOf(oCount));
            }
        });
    ...
    private void winningGame()
    {
        ...
        if((b1==1) && (b2==1) && (b3==1))
        {
            ...
            builder.setMessage("Player 1 Wins").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
            ...
            alertDialog.show();
            xCount++;
            player1.setText("Player 1 : "+String.valueOf(xCount));
        ...
        else  if((b3==1) && (b5==1) && (b7==1))
        {
            ...
            alertDialog.show();
            xCount++;
            player1.setText("Player : "+String.valueOf(xCount));
        ...
        else  if((b1==0) && (b2==0) && (b3==0))
        {
            ...
            AlertDialog.Builder builder=new AlertDialog.Builder(this);
            builder.setMessage("Player 2 Wins").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    button1.setImageDrawable(null);
                    button2.setImageDrawable(null);
